...
<audio id="sonido_recibirpedido" src="/sound/mozo.mp3"> </audio>
<audio id="sonido_demora" src="/sound/demora.mp3" loop> </audio>
<div class="row" style="position:; height:100px; z-index:99">
    <div class="col-xs-12 col-sm-12 col-12 col-lg-12" style="position:fixed; top:auto; z-index:99">
            ...
            <div class="panel-heading">
              ...
              <button type="submit" class="btn btn-danger btn-lg" id="ordenarpedidos" data-loading-text="Enviando.." accesskey="S"> <i class="fa fa-shopping-cart"></i> Ordenar Pedido</button>
              <button type="submit" class="btn btn-primary btn-lg" id="btn_precuenta" accesskey="P"><i class="fa fa-tasks" ></i> Precuenta</button>
            <button type="submit" class="btn btn-success btn-lg" id="btn_cobrar" accesskey="O"><i class="fa fa-usd"></i> Cobrar Pedido</button>
            <button type="submit" class="btn btn-info btn-lg" id="btn_partircuenta"><i class="fa fa-tags"></i> Partir Cuenta</button>


             <button type="submit" class="btn btn-primary btn-lg" id="btn_cerrarmesa" accesskey="C"><i class="fa fa-external-link"></i> Cerrar Mesa</button>
            ...
            <button type="submit" class="btn btn-warning btn-lg" id="btn_salirmesa" accesskey="R"><i class="fa fa-reply-all" ></i> Regresar</button>
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                	<div class="row">
                		<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                			<h4 style="color:#fff;font-weight:bold;">Total de productos: <span class="NmrItms"></span></h4>
	                	</div>
	                	<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
	                	<h4 style="color:#fff;font-weight:bold;">Importe Total: <span class="montoTotalcu"></span></h4>
	                	</div>
	                </div>
                </div >
                ...
                @if (isset($combinacionesp))
                	@foreach ($combinacionesp as $dato)
                	    ...
                	    <?php $nombreComb = Combinacion::find($dato->combinacion_id);?>
						<li class="list-group-item" data-enviado="1">
							<div class="row">
								...
								<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
									<ul class="list-group list-group-flush" data-toggle="tooltip" data-placement="top" title="{{$nombreComb->nombre}}">
										@foreach ($placombinacionp[$dato->combinacion_id.'_'.$dato->combinacion_c] as $plato)
                                            ...
                                            &nbsp;{{$plato->pnombre}}<br>
                                                                            <span class="small text-warning">
                                                                                <?php $detalle = DetPedido::find($plato->id);
                                                                                    //print_r($detalle->notas->toJson());
                                                                                    foreach ($detalle->notas as $detnota){
                                                                                        echo "/".$detnota->descripcion." ";
                                                                                    }
...
<script type="text/x-kendo-template" id="template_cestacombinaciones">
    <li class="list-group-item">
    	<div class="row">
    		<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
    			<div class="row">
    				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 text-center" style="padding-left:7px;">
    					<a href="javascript:void(0)" class="btn btn-info btn_pluscanti" data-iddatasour = "#:id#">
    					<span class="glyphicon glyphicon-plus"></span>
						</a>
    				</div>
    				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 text-center" style="padding-left:7px;">
    					<a href="javascript:void(0)" class="btn btn-info btn_mincanti" data-iddatasour = "#:id#">
    						<span class="glyphicon glyphicon-minus"></span>
    					</a>
    				</div>
    				<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-center" style="padding-left:7px;">
	    				...
	    				<li class="list-group-item">
	    					<div class="row">
		    					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    			<i class="fa fa-files-o fa-2x notas" data-filaid ="#=id#" data-id="#=eval(producombi[i]).idprocombi#" data-procombi ="#=producombi[i]#"></i>
					    		</div>
	    						<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
    		...
    		<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
    			<div class="row">
    				...
    				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
    					<a href="javascript:void(0)" class="btn btn-danger reitemcesta" data-iddatasour = "#:id#">
...
<script type="text/x-kendo-template" id="template_cestaproductos">
    <li class="list-group-item">
    	<div class="row">
    		<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
    			<i class="fa fa-files-o fa-2x notas" data-filaid ="#=id#" data-id="#=idpro#"></i>
    		</div>
    		<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
    			<div class="row">
    				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 text-center" style="padding-left:7px;">
    				...
    				<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-center">
    					<input type="text" value="#:cantidad#" class="form-control kendoNumr" tabindex="0">
    				</div>
    			</div>
    		</div>
    		...
    		<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
    			<div class="row">
    				...
    				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3" style="padding-left:7px;">
    ...
    <div class="modal-body">
        <div class="pull-left" style="width: 37%">
            <div class="btn-group btn-group-lg">
              <button type="button" class="btn btn-info" id="btn_efectivo">Efectivo</button>
              <button type="button" class="btn btn-info" id="btn_tarjeta">Tarjeta</button>
              <button style="border-radius:0px 6px 6px 0px" type="button" class="btn btn-warning" id="dLabel" data-toggle="dropdown" role="button">
        ...
        <div class="pull-left" style="width: 60%">
            <form class="form-inline" role="form">
              <div class="form-group" style="width:60%">
                <input type="email" id="buscar_cliente" class="form-control" placeholder="Ingrese DNI/RUC/TEXTO" style="width:100%">
              </div>
              <a href="javascript:void(0)" class="btn btn-info" id="btn_nuevocliente">Nuevo Cliente</a>
            </form>
            <br>
            <br>
        ...
        <button type="button" class="btn btn-success pull-right"  id="btn_cobraraceptar"
                style="margin-top: -8px">
                Aceptar</button>
        <button type="button" class="btn btn-danger pull-right" style="margin-right: 5px; margin-top: -8px"
...
<style>
	...
	.product {
        ...
        .product:hover p {
            ...
            background-image: url('/images/productos/arrow-right.png');
