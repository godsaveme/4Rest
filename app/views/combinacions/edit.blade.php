  ...
  <div class="form-group">
    ...
    {{Form::label('lblTipoComb', 'Tipo de Combinación',array('class'=>'control-label'))}}
		...
		{{Form::label('HoraInicio', 'Hora Inicio',array('class'=>'control-label'))}}
			{{Form::input('text', 'HoraInicio',  $combinacion->HoraInicio, array('id'=>'HoraInicio','class'=>'form-control'))}}
		</div>
		<div class="col-md-3">
		{{Form::label('HoraTermino', 'Hora Termino',array('class'=>'control-label'))}}
			{{Form::input('text', 'HoraTermino', $combinacion->HoraTermino, array('id'=>'HoraTermino','class'=>'form-control'))}}
		</div>
	</div>
    <div class="form-group">
    <div class="col-md-4">
	  	{{Form::label('FechaInicio', 'Fecha Inicio',array('class'=>'control-label'))}}
	  	{{Form::input('text', 'FechaInicio', $combinacion->FechaInicio, array('id'=>'FechaInicio','class'=>'form-control'))}}
	  </div>
	  <div class="col-md-4">
	  	{{Form::label('FechaTermino', 'Fecha Termino',array('class'=>'control-label'))}}
	  	{{Form::input('text', 'FechaTermino', $combinacion->FechaTermino, array('id'=>'FechaTermino','class'=>'form-control'))}}
	  </div>
	</div>
	<div class="form-group">
	  <div class="col-md-2">
