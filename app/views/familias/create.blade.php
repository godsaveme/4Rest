...
{{ Form::open(array('id'=>'form_resto','url' => 'familias/store' , 'enctype' => 'multipart/form-data' , 'class'=>'form-horizontal')) }}
<fieldset>
  <legend></legend>
  ...
  <div class="form-group">
    ...
    <div class="col-md-5">
        {{Form::text('nombre', '', array('class' => 'form-control','placeholder'=>'ej. Salón 1', 'required', 'validationMessage'=>'Por favor entre un nombre.'))}}
    </div>
</div>
