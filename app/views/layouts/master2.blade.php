...
<!--                 <li class="dropdown-header">Nav header</li>
              ...
              <ul class="dropdown-menu">
                ...
                <li><a onclick="openCollapse();" href="#"><i class="fa fa-file-text-o"></i>  Reportes</a></li>
                <li><a onclick="hideCollapse();" href="#"><i class="fa fa-users"></i>  Crear Usuario</a></li>
                <li class="divider"></li>
<!--                 <li class="dropdown-header">Nav header</li>
                <li><a href="#">Separated link</a></li> -->
                <li><a href="/logout"><i class="fa fa-sign-out"></i> Salir</a></li>
...
<div class="panel-group" id="accordion4">
  <div class="panel panel-primary">
    ...
    <div id="collapseOne4" class="panel-collapse collapse @if (Request::is('personas') || Request::is('personas/*') || Request::is('personas/empresas') || Request::is('personas/empresas/*')) in @endif">
    <div class="panel-body pb-menu">
      <ul class="list-group">
