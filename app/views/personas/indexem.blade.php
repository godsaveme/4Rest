...
@section('sub-content')
  @parent
<a id="cntnr1" style="opacity: 0;" href="{{URL('personas/createempresas')}}" class='pull-right btn btn-primary'><i class="fa fa-edit"></i> Crear Empresa</a>

<div id="cntnr2" style="opacity: 0;" class="panel-heading"><strong><i class="glyphicon glyphicon-th"></i> EMPRESAS
</strong></div>
...
<table id="gridPersonas">
      ...
      <thead>
        <tr>
          <th data-field="nombre">Razón Social</th>
