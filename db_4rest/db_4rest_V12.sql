...
--
-- Servidor: localhost
-- Tiempo de generación: 15-03-2014 a las 20:55:25
...
CREATE TABLE IF NOT EXISTS `AreadeProduccion` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_AreadeProduccion_1_idx` (`id_tipo`),
  KEY `fk_AreadeProduccion_2_idx` (`id_restaurante`)
...
INSERT INTO `AreadeProduccion` (`id`, `nombre`, `descripcion`, `id_tipo`, `id_restaurante`, `habiitado`, `created_at`, `updated_at`) VALUES
(1, 'Cocina', 'Cocina', 1, 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
INSERT INTO `restaurante` (`id`, `nombreComercial`, `razonSocial`, `ruc`, `direccion`, `comentarios`, `imagen`, `pais`, `provincia`, `distrito`, `tel`, `fax`, `cel`, `created_at`, `updated_at`) VALUES
(1, 'Kango', 'K&C International SAC', '2050783173', 'Elisas Aguirre #123', 'Restaurante elias aguirre', NULL, 'Peru', 'Chiclayo', 'Chiclayo', '252711', NULL, '982604940', '0000-00-00 00:00:00', NULL);
...
CREATE TABLE IF NOT EXISTS `Usuario` (
  ...
  `id_restaurante` int(11) NOT NULL,
  `id_tipoareapro` int(11) unsigned NOT NULL,
  `estado` tinyint(1) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `fk_Usuario_1_idx` (`persona_id`),
  KEY `fk_Usuario_2_idx` (`id_restaurante`),
  KEY `fk_Usuario_3_idx` (`id_tipoareapro`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
ALTER TABLE `Usuario`
  ...
  ADD CONSTRAINT `fk_Usuario_3` FOREIGN KEY (`id_tipoareapro`) REFERENCES `TipoAreadeProduccion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
