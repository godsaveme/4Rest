...
--
-- Servidor: localhost
-- Tiempo de generación: 01-03-2014 a las 00:40:41
...
CREATE TABLE IF NOT EXISTS `Modulos` (
  ...
  `controladores` varchar(50) NOT NULL COMMENT 'nombre de controlador',
  `procesos` varchar(50) NOT NULL COMMENT 'nombre de metodo',
  `activo` int(11) NOT NULL COMMENT 'si esta activo el proceso o no',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tabla para asignar permisos a los usarios se enlaza con perfiles';
...
(1, 'icalvay', '$2y$10$0SG7XTNUH/KjsJJwZFxiRuqQp5WF2a2gFDfLpW', 2, '2014-02-28 23:36:07', '2014-02-28 23:36:07', 1),
(2, 'jalvarez', '$2y$10$mOqhmxiAHh9yn/Yj3a7aTuWNB7xWbGC/iv2qCn', 1, '2014-03-01 00:03:48', '2014-03-01 00:03:48', 1);
